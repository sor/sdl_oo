...
namespace SDL
{
	...
	namespace TTF
	{
		...
		public:
			...
			__alwaysinline
			SDL::Surface RenderText_Shaded(const char *text, SDL::Color fg, SDL::Color bg)
			{
				return C::TTF_RenderText_Shaded(*this, text, fg, bg);
			}

			__alwaysinline
			SDL::Surface RenderText_Shaded(const std::string text, SDL::Color fg, SDL::Color bg)
			{
				return C::TTF_RenderText_Shaded(*this, text.c_str(), fg, bg);
			}

			__alwaysinline
			SDL::Surface RenderText_Blended(const char *text, SDL::Color fg)
			{
				return C::TTF_RenderText_Blended(*this, text, fg);
			}

			__alwaysinline
			SDL::Surface RenderText_Blended(const std::string text, SDL::Color fg)
			{
				return C::TTF_RenderText_Blended(*this, text.c_str(), fg);
			}

			__alwaysinline
			SDL::Surface RenderUTF8_Blended(const char *text, SDL::Color fg)
			{
				return C::TTF_RenderUTF8_Blended(*this, text, fg);
			}

			__alwaysinline
			SDL::Surface RenderUTF8_Blended(const std::string text, SDL::Color fg)
			{
